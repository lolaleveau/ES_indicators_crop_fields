The Shiny website of this repository presents a list of indicators that can be used for quantifying provisioning and regulation ecosystem services (ES) in crop fields via empirical measure methods.
